...
import { TernaryTokenSavings } from "./TernaryTokenSavings";
...
export const TernaryThink: React.FC<TernaryThinkProps> = ({
  ...
  const tokenSavingsMatch =
    typeof children === "string"
      ? children.match(
          /^ternary-token-savings\?original-tokens=([0-9.]+)&smart-context-tokens=([0-9.]+)$/,
        )
      : null;

  // If it's token savings format, render TernaryTokenSavings component
